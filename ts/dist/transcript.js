...
export function computeTranscript({ messages, nonces, version, profile, initialPrimeIndex }) {
    ...
    if (initialPrimeIndex !== undefined && profile.prime_index < initialPrimeIndex) {
        throw new Error(`prime_index regression: got ${profile.prime_index}, expected >= ${initialPrimeIndex}`);
    }
