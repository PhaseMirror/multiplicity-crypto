/* @ts-self-types="./multiplicity_crypto_rust.d.ts" */
...
class PedersenCommitment {
    ...
    commit(v) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.pedersencommitment_commit(this.__wbg_ptr, v);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @returns {string}
     */
    commit_with_blind(v, r_bytes) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passArray8ToWasm0(r_bytes, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.pedersencommitment_commit_with_blind(this.__wbg_ptr, v, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor() {
        const ret = wasm.pedersencommitment_new();
        this.__wbg_ptr = ret;
        PedersenCommitmentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) PedersenCommitment.prototype[Symbol.dispose] = PedersenCommitment.prototype.free;
exports.PedersenCommitment = PedersenCommitment;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./multiplicity_crypto_rust_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/multiplicity_crypto_rust_bg.wasm`;
